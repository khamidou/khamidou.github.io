...
It's a good thing because customers get to talk directly to the person who wrote the API they're using. On the other hand, engineers can often be a bit gruff[^gruff].

I've learned a ton helping customers getting started with our API, and I thought I'd share three important things I've noticed.
...
Instead, take 5 minutes to dig through your logs. It's very possible that you'll find what's the actual problem without having to ask your customer. You'll have saved your customer some time and appeared to be a mind-reader.
